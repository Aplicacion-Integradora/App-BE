...
using ScriptedReviews.MultiTenancy;
...
using ScriptedReviews.HealthChecks;
...
[DependsOn(
    typeof(ScriptedReviewsHttpApiModule),
...
public class ScriptedReviewsHttpApiHostModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        PreConfigure<OpenIddictBuilder>(builder =>
        {
            ...
            {
                options.AddAudiences("ScriptedReviews");
        ...
        if (!hostingEnvironment.IsDevelopment())
        {
            ...
            {
                serverBuilder.AddProductionEncryptionAndSigningCertificate("openiddict.pfx", "67334216-c21f-4b6a-b42a-3251ccb6126d");
    ...
    private void ConfigureConventionalControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(ScriptedReviewsApplicationModule).Assembly);
        });
    }
    ...
    private static void ConfigureSwagger(ServiceConfigurationContext context, IConfiguration configuration)
    {
        context.Services.AddAbpSwaggerGenWithOidc(
            ...
            options =>
            {
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "ScriptedReviews API", Version = "v1" });
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "ScriptedReviews API");
